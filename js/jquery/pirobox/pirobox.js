		  ...
		  var corners = 
			...
			$(piro_gallery).each(function(array) {
					...
					item.bind('click',function(c) {
						...
						if( descr == ""){
						caption.html('<p>'+ this_url+'<em class="number">' + number + '</em><a href='+ encodeURIComponent(this_url) +' class="link_to" target="_blank" title="Open Image in a new window"></a></p>');
						}else{
						caption.html('<p>'+ descr+'<em class="number">' + number + '</em><a href='+ encodeURIComponent(this_url) +' class="link_to" target="_blank" title="Open Image in a new window"></a></p>');
						}
						if(item.is('.last')){
